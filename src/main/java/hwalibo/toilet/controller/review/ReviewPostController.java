...
public class ReviewPostController {
    ...
    @Operation(
            summary = "리뷰 업로드",
            description = "리뷰 업로드하기",
            security = { @SecurityRequirement(name = "bearerAuth") }
    )
    @PostMapping(value = "/{toiletId}/reviews")
    public ResponseEntity<ApiResponse<ReviewCreateResponse>> uploadReview(
    ...
    public ResponseEntity<ApiResponse<PhotoUploadResponse>> uploadImage(
            @AuthenticationPrincipal User loginUser,
